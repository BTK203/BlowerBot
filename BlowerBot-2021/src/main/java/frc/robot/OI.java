...
public class OI {
    ...
    public OI() {
        ...
        JoystickButton blowLoudHorn = new JoystickButton(DRIVER, Xbox.B);
            blowLoudHorn.whileHeld(new ButtonCommandBlowLoudHorn());

        //blow double horn exclusively
        JoystickButton blowDoubleHorn = new JoystickButton(DRIVER, Xbox.Y);
            blowDoubleHorn.whileHeld(new ButtonCommandBlowDoubleHorn());

        //blow both horns
        JoystickButton blowBothHorns = new JoystickButton(DRIVER, Xbox.A);
            blowBothHorns.whileHeld(new ButtonCommandBlowBothHorns());

        //ring the cowbells
        JoystickButton ringCowbells = new JoystickButton(DRIVER, Xbox.X);
